...
if text == 'تحديث السورس' and msg.ControllerBot then 
os.execute('sudo rm -fr Jack.lua')
os.execute('wget https://raw.githubusercontent.com/bandarr005/t/main/Jack.lua')
LuaTele.sendText(msg.chat_id_, msg.id_,'• تم تحديث السورس')  
dofile('lua Jack.lua')
end
...
if text == 'تعا اذاعه' or text == 'تفعيل الاذاعه' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• عذراً الامر يخص ↤︎ 〖  '..Controller_Num(1)..' 〗 فقط . ',"md",true)  
end
